...
- quiz    : 문제를 내달라는 요청. '취약/약점 문제'처럼 조건이 붙어도 '문제를 달라'면 quiz.
            ("문제 내줘", "조선 후기 경제 문제 줘", "한 문제 더", "취약 영역 문제 줘", "약점 부분 문제 내줘")
- grade   : 방금 낸 문제에 대한 답안 제출 (숫자 하나 "3", "3번", "정답 2번")
- weakness: 자신의 약점을 '진단·확인'해 달라는 요청(문제 요청이 아님). ("나 뭐가 약해?", "약점 알려줘", "오답노트 보여줘")
